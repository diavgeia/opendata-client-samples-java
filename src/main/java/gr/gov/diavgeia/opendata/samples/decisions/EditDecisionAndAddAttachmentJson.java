...
public class EditDecisionAndAddAttachmentJson {
    private static final String METADATA_FILE_PATH = "/gr/gov/diavgeia/opendata/samples/decisions/EditPublishedDecisionAndAddAttachment.json";
    
    public static void main(String[] args) throws Exception {
        Configuration conf = new Configuration();
        String jsonString;
        try (InputStream jsonStream = EditDecisionAndAddAttachmentJson.class.getResourceAsStream(METADATA_FILE_PATH)) {
