 ...
 */
public class PublishDecisionAndNotifyRecipients {
    ...
    private static DecisionStoreRequest createDecisionStoreRequest() {
        ...
        decision.setActions(asList(createNotifyRecipientsAction()));
    ...
    // Creates a list of recipients that will be notified via email
    private static DecisionStoreRequestAction createNotifyRecipientsAction() {
        DecisionStoreRequestAction action = new DecisionStoreRequestAction();
        action.setName("notifyRecipients");
        action.setArgs(asList("alice.jones@example.com", "bob.loblaw@example.com", "charly.saiz@example.com"));
        return action;
    }
