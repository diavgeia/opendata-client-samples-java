...
import gr.gov.diavgeia.opendata.json.DecisionStoreRequestAction;
 ...
 */
public class SubmitTempDecisionAndDefineAction {
    ...
    private static DecisionStoreRequest createDecisionStoreRequest() {
        ...
        decision.setPublish(false);
        
        // Define action to be executed after successfully storing the decision
        decision.setActions(asList(createAction()));
        
        return decision;
    }
    
    private static DecisionStoreRequestAction createAction() {
        DecisionStoreRequestAction action = new DecisionStoreRequestAction();
        // action.setName("onPublishNotifyRestService");
        action.setName("requestRestNotification");
        action.setArgs(asList("https://thirdpartysystem.gr/services/diavgeia", "user", "password"));
        return action;
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        // MultipartPostHttpRequestBuilder post = HttpRequests.postMultipart("https://localhost/luminapi/opendata/decisions");
